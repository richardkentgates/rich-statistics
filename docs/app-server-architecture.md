...
|-----|-----------|---------|--------|
| **Production** | `rs-app.richardkentgates.com` | `/var/www/rs-app/public_html` | `main` |
| **Dev** | `rs-dev.richardkentgates.com` | `/var/www/rs-app-dev` | `develop` |
| **Test** | `rs-test.richardkentgates.com` | `/var/www/rs-app-test` | `test` |
...
certbot --apache -d rs-app.richardkentgates.com
...
<IfModule mod_ssl.c>
<VirtualHost *:443>
    ServerName rs-app.richardkentgates.com
    ...
    SSLCertificateFile /etc/letsencrypt/live/rs-app.richardkentgates.com/fullchain.pem
    SSLCertificateKeyFile /etc/letsencrypt/live/rs-app.richardkentgates.com/privkey.pem
</VirtualHost>
</IfModule>
```
...
### URL: `https://rs-app.richardkentgates.com/apt stable main`

### Signing key:
- **UID:** `Rich Statistics APT Signing Key <apt@rs-app.richardkentgates.com>`
...
```bash
certbot --apache -d rs-app.richardkentgates.com
certbot --apache -d rs-dev.richardkentgates.com
certbot --apache -d rs-test.richardkentgates.com
```
...
```
/etc/letsencrypt/live/rs-app.richardkentgates.com/
/etc/letsencrypt/live/rs-dev.richardkentgates.com/
/etc/letsencrypt/live/rs-test.richardkentgates.com/
```
...
| URL | Check |
|-----|-------|
| `https://rs-app.richardkentgates.com/` | Returns 200 |
| `https://rs-dev.richardkentgates.com/` | Returns 200 |
| `https://rs-test.richardkentgates.com/` | Returns 200 |
