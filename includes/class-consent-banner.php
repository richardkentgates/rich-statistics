 ...
 * and a persistent privacy trigger button for ongoing consent access.
 *
...
class RSA_Consent_Banner {
	...
	/**
	 * Output banner HTML, return button, and persistent privacy trigger in the footer.
	 */
	public static function render(): void {
		...
		$trigger_label   = __( 'Privacy Settings', 'rich-statistics' );
		...
		<button id="rsa-consent-trigger-btn" aria-label="<?php esc_attr_e( 'Privacy Settings', 'rich-statistics' ); ?>" title="<?php esc_attr_e( 'Change your privacy settings', 'rich-statistics' ); ?>"><?php echo esc_html( $trigger_label ); ?></button>
		<?php
	}
	 ...
	 *
	 * @param array $styles Admin style settings.
	 */
