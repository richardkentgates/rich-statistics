...
if ( ! ( function_exists( 'rs_fs' ) && rs_fs()->can_use_premium_code__premium_only() ) ) {
	...
	<div class="rsa-upsell-notice">
		<h2><?php esc_html_e( 'Campaigns is a Premium Feature', 'rich-statistics' ); ?></h2>
		<p><?php esc_html_e( 'Track UTM campaigns, sources, and mediums to measure the impact of every marketing channel.', 'rich-statistics' ); ?></p>
		<?php if ( function_exists( 'rs_fs' ) ) : ?>
		<a href="<?php echo esc_url( rs_fs()->get_upgrade_url() ); ?>" class="button button-primary button-hero">
			<?php esc_html_e( 'Upgrade to Unlock Campaigns', 'rich-statistics' ); ?>
		</a>
		<?php endif; ?>
	</div>
	<?php
