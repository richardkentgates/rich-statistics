...
class AnalyticsTest extends WP_UnitTestCase {
	...
	public function test_get_click_map_rows_have_expected_keys(): void {
		...
		// Cleanup
		$wpdb->delete( $wpdb->prefix . 'rsa_clicks', array( 'session_id' => 'test-session-clickmap' ) ); // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching
	}
	/**
	 * ----------------------------------------------------------------
	...
	public function test_get_campaigns_rows_have_expected_keys(): void {
		...
		$wpdb->delete( $wpdb->prefix . 'rsa_events', array( 'session_id' => 'test-session-campaigns' ) ); // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching
	}
	/**
	 * ----------------------------------------------------------------
